      ...
      <div class="post-list">
        ...
        <div class="post-c">
          ...
          <div class="post-c-btn">
            ...
            <!-- 消去用 -->
            <p><a class="btn btn-trash" href="/post/{{$list->id}}/delete" onclick="return confirm('この投稿を削除します。よろしいですか？')"><img src="./images/trash-h.png" alt="消去1"><img src="./images/trash.png" alt="消去2"></a></p>
          </div>
          @endif
        </div>
      </div>
