    ...
    <div class="post-c">
      ...
      <div class="post-c-btn">
       ...
       <a class="js-modal-open" href="" post="{{ $list->post }}" post_id="{{ $list->id }}"><img src="./images/edit.png" alt="編集"></a>
            ...
            <!-- 消去用 -->
        <p>
        <a class="btn btn-trash" href="/post/{{$list->id}}/delete" onclick="return confirm(
       'この投稿を削除します。よろしいですか？')"><img src="./images/trash-h.png" alt="消去1"><img src="./images/trash.png" alt="消去2">
        </a>
        </p>
       </div>
       @endif
